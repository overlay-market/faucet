...
export class BlockchainService {
  ...
  constructor(private configService: ConfigService) {
    ...
    const testnetProviderUrl =
      this.configService.get<string>("testnetProviderUrl")
    const mainnetProviderUrl =
      this.configService.get<string>("mainnetProviderUrl")
    ...
    this.signer = new NonceManager(
      new ethers.Wallet(fundsWallet, testnetProvider),
    )
